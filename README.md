...
- [x] 사용자가 제시할 숫자 입력 받기
- [x] 게임 재실행 여부 받기 (Y or N)

### 게임 실행

- [x] 난수 생성
- [x] 난수보다 사용자가 입력한 값이 더 높으면 "더 낮게"
- [x] 사용자가 입력한 값이 난수보다 더 낮으면 "더 크게"

### 결과

- [x] 기회를 다 소모하면 게임 오버 후 정답 공개
- [x] 기회를 다 소모하기 전 맞췄을 경우 정답 판정과 시행 횟수 공개
...
- [x] 문자열을 입력했을 때
- [x] 1 ~ 100 범위에 속하지 않는 숫자일 때

#### 재실행 여부 입력

- [x] Y나 N이 아닌 다른 문자열을 입력했을 때
